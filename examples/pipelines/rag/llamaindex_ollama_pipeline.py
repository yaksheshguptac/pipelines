    ...
    def __init__(self):
        ...
        self.valves = self.Valves(
            **{
                ...
                "LLAMAINDEX_MODEL_NAME": os.getenv("LLAMAINDEX_MODEL_NAME", "llama3.3:latest"),
                "LLAMAINDEX_EMBEDDING_MODEL_NAME": os.getenv("LLAMAINDEX_EMBEDDING_MODEL_NAME", "llama3.3:latest"),
            }
        )
